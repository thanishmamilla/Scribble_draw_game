...
import 'package:scribble_scratch/final_leaderboard.dart';
import 'package:scribble_scratch/home_screen.dart';
import 'package:scribble_scratch/model/my_custom_painter.dart';
import 'package:scribble_scratch/model/touch_points.dart';
import 'package:scribble_scratch/sidebar/Player_scoreboard_drawer.dart';
import 'package:scribble_scratch/waiting_lobby_screen.dart';
...
class PaintScreen extends StatefulWidget {
  ...
  PaintScreen({required this.data, required this.screenFrom}) {
    print(
        "PaintScreen constructor loaded with data: $data, screenFrom: $screenFrom");
  }
...
class _PaintScreenState extends State<PaintScreen> {
  ...
  void connect() {
    _socket = IO.io('http://172.20.10.3:3000', <String, dynamic>{
...
//   void connect() {
//     _socket = IO.io('http://192.168.29.155:3000', <String, dynamic>{
//       'transports': ['websocket'],
//       'autoConnect': false
//     });
//     _socket.connect();
...
//                           ],
//                         ),
//                         dataOfRoom['nickname'] != widget.data['nickname']
//                             ? Align(
//                                 alignment: Alignment.bottomCenter,
//                                 child: Container(
//                                     margin:
